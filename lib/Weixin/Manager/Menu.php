...
class Menu
{
    ...
    {
        $rst = $this->_request->post('menu/addconditional', $menusWithMatchrule);
        return $this->_client->rst($rst);
    }
    ...
    public function delconditional($menuid)
    {
        ...
        $rst = $this->_request->post('menu/delconditional', $params);
        return $this->_client->rst($rst);
    }
    ...
    public function trymatch($user_id)
    {
        ...
        $rst = $this->_request->post('menu/trymatch', $params);
        return $this->_client->rst($rst);
    }
}
